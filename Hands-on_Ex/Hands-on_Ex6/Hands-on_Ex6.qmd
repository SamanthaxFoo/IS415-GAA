...
In this hands-on exercise, I will compute the global and local measures of spatial autocorrelation by using **spdep** package. These are the goals of this exercise:
...
In this case study, we will examine the spatial pattern of GDP per capita of [Hunan Provice](#0), People Republic of China by answering the questions:
...
## 8. Local Measures of Spatial Association (LISA)
