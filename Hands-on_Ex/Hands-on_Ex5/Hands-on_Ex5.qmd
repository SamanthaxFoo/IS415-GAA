...
```{=html}
<button>Hands-on Exercise</button> <button>R</button> <button>sf</button> <button>tmap</button><button>spdep</button><button>knitr</button>
```
## 1. Overview
...
![](images/clipboard-3126129385.png){width="793"}
