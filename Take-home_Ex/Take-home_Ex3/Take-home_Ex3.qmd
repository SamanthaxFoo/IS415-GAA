...
Let's quickly prepare all the required data which goes down to the granularity of **queen** and **rook** methods to locate its neighbours. For this case, I will not be categorising the data by **origin** and **destination** since the distribution of POIs is uniform across districts, making it unnecessary to differentiate based on origin and destination.
