...
ggplot(aggregated_pois, aes(x = category, y = num_of_trips, fill = time_of_day)) +
  ...
  geom_text(aes(label = num_of_trips), 
            ...
            size = 3.5) +
  labs(
    title = "Number of Trips Taken Using Grab by Time of Day",
    x = "POI Category",
    y = "Number of Trips"
  ) +
  theme_gray() +
...
![EDA - Overall Trips Analysis, All Trip Type, Driving Mode, Weather, Time and Days](images/EDA%20Overall-04.png){width="1000"}

![EDA Prototype -By Point of Interest, All Trip Type, Driving Mode, Weather, Time and Days](images/EDA%20POI-01.png){width="1000"}
...
# Second map: Statistically Significant LISA Map
lisa_queen_origin_sig <- lisa_queen_origin_sig %>%
  mutate(label = paste("District:", district, "| ", mean))
...
![ESDA Prototype - Destination, All Driving Mode, All Weather, Queen Method, Statistically Significant](images/LISA%202-02.png){width="1000"}

![ESDA Prototype - Origin, Car, All Weather, Queen Method, Statistically Significant](images/LISA%203-02.png){width="1000"}
